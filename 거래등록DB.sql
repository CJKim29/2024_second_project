/*
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_dex, req_lev,
                      	option1, option2, option3, option4, option5, option6, reg_mem_name)
						values (seq_reg_item_idx.nextVal, '천상의 의복.jpg', '천상의 의복'||chr(10)||'라이트 플레이트', 2000, 0, sysdate, 2, '갑옷', '노멀', 
        				'방어력:216', '내구도:60', '필요 힘:41', '', '요구 레벨:29', '언데드에게 주는 피해 +50%', '언데드에 대한 명중률 +100', '방어력 +100% 증가',
        				'마력 +15', '마나 재생 25%', '모든 저항 +10', '일길동');
	
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, req_str, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '시대의 왕관 코로나.jpg', '시대의 왕관'||chr(10)||'코로나', 10000, 0, sysdate, 3, '투구', '엘리트',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, req_str, req_lev,
  						...
  						values(seq_reg_item_idx.nextVal, '폭풍막이.jpg', '폭풍막이'||chr(10)||'모너크', 7000, 0, sysdate, 3, '방패', '엘리트', 
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_lev,
							option1, option2, option3, option4, option5, option6, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '마수.jpg', '마수'||chr(10)||'라이트 건틀릿', 2500, 0, sysdate, 1, '장갑', '노멀',
  						'방어력:24~25', '내구도:18', '필요 힘:45', '요구 레벨:23', '화염 기술 +1', '시전 속도 +20%', '화염 피해 1 - 6 추가',
  						'방어력 +20~30%증가', '방어력 +10', '마나 재생 25%', '일길동');
 	
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '전쟁 여행자.jpg', '전쟁 여행자'||chr(10)||'배틀 부츠', 15000, 0, sysdate, 3,  '신발', '익셉셔널',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_lev,
							option1, option2, option3, option4, option5, option6, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '서슬꼬리.jpg', '서슬꼬리'||chr(10)||'사크스킨 벨트', 1500, 0, sysdate, 2, '벨트', '익셉셔널',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, req_lev,
							option1, option2, option3, option4, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '요르단의 반지.jpg', '요르단의 반지'||chr(10)||'반지', 20000, 0, sysdate, 1, '반지',
  						'요구 레벨:29', '모든 기술 +1', '번개 피해 1 - 12 추가', '마나 +20', '최대 마나 25% 증가', '일길동');
 	
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, req_lev,
							option1, option2, option3, option4, option5, option6, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '대군주의 진노.jpg', '대군주의 진노'||chr(10)||'목걸이', 13000, 0, sysdate, 2, '목걸이',
  						'요구 레벨:65', '모든 기술 +1', '공격 속도 +20%', '번개 피해 1 - 30 추가', '치명적 공격 +0~37%(캐릭터 레벨에 비례)',
  						'번개 저항 +35%', '공격자가 번개 피해를 15받음', '이길동');
 	
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_dex, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '심장 도리깨.jpg', '심장 도리깨'||chr(10)||'런들', 1000, 0, sysdate, 3, '단도', '익셉셔널',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, req_str, req_dex, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, option9, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '푸른 서슬.jpg', '푸른 서슬'||chr(10)||'페이즈 블레이드', 1200, 0, sysdate, 2, '한손검', '엘리트',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_dex, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '죽음나락 불길.jpg', '죽음나락 불길'||chr(10)||'즈바이핸더', 1500, 0, sysdate, 1, '양손검', '익셉셔널',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_lev,
							option1, option2, option3, option4, option5, option6, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '죽음의 날.jpg', '죽음의 날'||chr(10)||'액스', 1000, 0, sysdate, 2, '한손도끼', '노멀',
  						'한손 피해:14 - (17~18)', '내구도:24', '필요 힘:32', '요구 레벨:9', '공격 속도:[10]', '피해 +60~70% 증가',
  						'최소 피해 +8', '명중률 보너스 15%', '적중 시 대상 실명', '적 처치 시 마나 +4', '삼길동');
 	
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '미노타우루스.jpg', '미노타우루스'||chr(10)||'에이션트 액스', 700, 0, sysdate, 3, '양손도끼', '익셉셔널',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_dex, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '사신의 종소리.jpg', '사신의 종소리'||chr(10)||'쓰레셔', 100000, 0, sysdate, 2, '미늘창', '엘리트',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_dex, req_lev,
  						...
  						values(seq_reg_item_idx.nextVal, '서슬가지.jpg', '서슬가지'||chr(10)||'트라이던트', 500, 0, sysdate, 1, '창', '노멀',
  						'양손 피해: (11~13) - (19~22)', '내구도:35', '필요 힘:38', '필요 민첩:24', '요구 레벨:12', '공격 속도:[0]', '공격 속도 +30%',
  						'피해 +30~50% 증가', '대상의 방어력 -50%', '대상 감속 25%', '힘 +15', '민첩 +8', '삼길동');
  	
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, req_str, req_dex, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, option9, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '바람살.jpg', '바람살'||chr(10)||'히드라 보우', 30000, 0, sysdate, 2, '활', '엘리트',
  	...
  	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, req_str, req_dex, req_lev,
  							option1, option2, option3, option4, option5, option6, option7, option8, option9, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '눈보라 포.jpg', '눈보라 포'||chr(10)||'발리스타', 15000, 0, sysdate, 3, '석궁', '익셉셔널',
  	...
  	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_lev,
  							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '이로의 횃불.jpg', '이로의 횃불'||chr(10)||'원드', 500, 0, sysdate, 2, '한손지팡이', '노멀',
  						'한손 피해: 2 - 4', '내구도:15', '요구 레벨:5', '공격 속도:[0]', '강령술사 기술 레벨 +1', '화염 피해 5 - 9 추가', 
  						'적중당 생명력 6% 훔침', '마력 +10', '마나 재생 5%', '시야 +3', '언데드에게 주는 피해 +50%', '삼길동');
  											
  	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_lev,
  							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '망 송의 가르침.jpg', '망 송의 가르침'||chr(10)||'아콘 스태프', 500000, 0, sysdate, 1, '양손지팡이', '엘리트',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_lev,
							option1, option2, option3, option4, option5, option6, option7, option8, reg_mem_name)
  						values(seq_reg_item_idx.nextVal, '대지진의 망치.jpg', '대지진의 망치'||chr(10)||'배틀 해머', 100, 0, sysdate, 2, '철퇴', '익셉셔널',
	...
	insert into reg_item (reg_idx, filename, reg_name, reg_price, auction_price, reg_date, reg_period, category, grade, intrinsic, durability, req_str, req_dex, req_lev,
  						...
  						values(seq_reg_item_idx.nextVal, '천상의 빛.jpg', '천상의 빛'||chr(10)||'마이티 셉터', 17000, 0, sysdate, 3, '홀', '엘리트', 
